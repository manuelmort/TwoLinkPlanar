...
class JacobianThreeDOFManipulator:
...
# Example usage
targets = [
    (6, 6, 6),  # Starting point
    (6, 9, 6),  # Move to top-left front
    (9, 9, 6),  # Move to top-right front
    (9, 6, 6),  # Move to bottom-right front
    (6, 6, 6),  # Back to bottom-left front
    (6, 6, 9),  # Move to bottom-left back
    (6, 9, 9),  # Move to top-left back
    (9, 9, 9),  # Move to top-right back
    (9, 6, 9),  # Move to bottom-right back
    (6, 6, 9),  # Back to bottom-left back
    (6, 9, 9),  # Connect to top-left back
    (6, 9, 6),  # Connect to top-left front
    (9, 9, 6),  # Connect to top-right front
    (9, 9, 9),  # Connect to top-right back
    (9, 6, 9),  # Connect to bottom-right back
    (9, 6, 6),  # Connect to bottom-right front
    (6, 6, 6)   # Return to starting point
]
